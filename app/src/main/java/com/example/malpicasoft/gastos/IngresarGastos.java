...
public class IngresarGastos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_ingresar_gastos, container, false);
    ...
    private void consultarFactura() {
        ...
        String URL = "http://malpicas.heliohost.org/malpica/gastos/gastos_consultar_factura.php?factura=" + datoNroFactura;
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET,URL,null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                gastosSetters.setNroFactura(jsonObject.getString("nro_factura"));

                                String nroFactura = gastosSetters.getNroFactura();
