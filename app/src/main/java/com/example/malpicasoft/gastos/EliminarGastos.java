...
public class EliminarGastos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_eliminar_gastos, container, false);
    ...
    private void consultarProducto() {
        ...
        String URL = "http://malpicas.heliohost.org/malpica/gastos/gastos_consultar_producto.php?codigo=" + datoCodigo;
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null,
                new Response.Listener<JSONObject>() {
