...
public class EliminarCompras extends Fragment {
    ...
    private void consultarProducto() {
        ...
        String URL = "http://malpicas.heliohost.org/malpica/compras/compras_consultar_producto.php?codigo=" + datoCodigo;
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null,
                new Response.Listener<JSONObject>() {
    ...
    private void eliminarFactura() {
        ...
        String URL1 = "http://malpicas.heliohost.org/malpica/compras/compras_eliminar_factura.php";
