...
public class EliminarClientes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_eliminar_clientes, container, false);
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if (!codigo.equals("No existe")){
                                    ...
                                    // SI NO DEVUELVE EL CÓDIGO, ENTONCES SE ELIMINA AL CLIENTE
                                    eliminarCliente();
                                }
                            }
